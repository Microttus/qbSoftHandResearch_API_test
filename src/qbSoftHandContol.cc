...
/*
    ...
    for (auto &id:qbSoftHandControl::device_ids_){
        qbSoftHandControl::dev_id = (int)id.id;
        break;
    }
    */
}
...
std::vector <int16_t> qbSoftHandControl::GetControlReference() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getControlReferences(control_references);
...
std::string qbSoftHandControl::GetDeviceInfo() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getInfo(INFO_ALL, info_string);
...
std::vector<int16_t> qbSoftHandControl::GetCurrents() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getCurrents(currents);
...
std::vector<int16_t> qbSoftHandControl::GetPositions() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getPositions(positions__);
...
std::vector<int16_t> qbSoftHandControl::GetVelocities() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getVelocities(velocities__);
...
std::vector<int16_t> qbSoftHandControl::GetAccelerations() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getAccelerations(accelerations__);
...
bool qbSoftHandControl::SetMotorStates(bool active) {
    ...
    if (soft_hands_.at(qbSoftHandControl::dev_id)->setMotorStates(active) == 0){
...
bool qbSoftHandControl::GetMotorStates() {
    bool activate = false;
    soft_hands_.at(qbSoftHandControl::dev_id)->getMotorStates(activate);
    if(activate){
        std::cout << "Motors are active";
    } else {
...
void qbSoftHandControl::SetGripValue(int grip, int spread) {  //TODO: Ask Muri about this formulation
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->setControlReferences(control_references);
...
std::vector<float> qbSoftHandControl::GetPositionPID() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamPositionPID(PID__);
...
std::vector<float> qbSoftHandControl::GetCurrentPID() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamCurrentPID(PID__);
    for (auto &param:PID__){
        std::cout << param << " ";
    }
    return PID__;
...
int qbSoftHandControl::GetId() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamId(device_id__);
...
int qbSoftHandControl::GetStartupActivation() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamStartupActivation(activation);
...
int qbSoftHandControl::GetInputMode() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamInputMode(input_mode);
...
int qbSoftHandControl::GetControlMode() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamControlMode(control_mode);
...
std::vector<uint8_t> qbSoftHandControl::GetEncoderResolution() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamEncoderResolutions(encoder_resolutions__);
...
std::vector<int16_t> qbSoftHandControl::GetEncoderOffsets() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamEncoderOffsets(encoder_offsets__);
...
std::vector<float> qbSoftHandControl::GetEncoderMultipliers() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamEncoderMultipliers(encoder_multipliers__);
...
int qbSoftHandControl::GetUsePositionLimits() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamUsePositionLimits(use_position_limits__);
...
std::vector<int32_t> qbSoftHandControl::GetPositionLimits() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamPositionLimits(position_limits__);
...
std::vector<int32_t> qbSoftHandControl::GetPositionMaxSteps() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamPositionMaxSteps(position_max_steps__);
...
int qbSoftHandControl::GetCurrentLimit() {
    ...
    soft_hands_.at(qbSoftHandControl::dev_id)->getParamCurrentLimit(current_limit__);
